...
TEST_CASE("Parse declaration, root element and check parsed information ", "[XML][Parse][Root]")
{
  ...
  SECTION("Empty root element <contact-info> ", "[XML][Parse]")
  {
    ...
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root()).name() == "contact-info");
  }
  ...
  SECTION("Root element <AddressBook> and one child <Address> with contents ", "[XML][Parse][Root]")
  {
    ...
    REQUIRE(XMLNodeRef<XMLNodeDeclaration>(xml.declaration()).standalone() == "no");
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root()).name() == "AddressBook");
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root()).children.size() == 3);
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root())[0].name() == "Address");
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root())[0].getContents() == "    This is some contents    ");
  }
  SECTION("Root element <AddressBook> with multiple sibling <Address> elements and contents ", "[XML][Parse][Root]")
  {
    ...
    REQUIRE(XMLNodeRef<XMLNodeDeclaration>(xml.declaration()).standalone() == "no");
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root()).name() == "AddressBook");
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root()).children.size() == 7);
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root())[0].name() == "Address");
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root())[0].getContents() == "\n    This is some contents 1   ");
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root())[1].name() == "Address");
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root())[1].getContents() == "\n    This is some contents 2   ");
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root())[2].name() == "Address");
    REQUIRE(XMLNodeRef<XMLNodeElement>(xml.root())[2].getContents() == "\n    This is some contents 3   ");
  }
}