...
int main([[maybe_unused]] int argc, [[maybe_unused]] char **argv)
{
  try {
    // Initialise logging.
    std::cout << "XML_Create_At_Runtime started ..." << std::endl;
    // Log version
    ...
    std::cout << "attrib1 = " <<xl::NRef<xl::Element>(xml.root())["attrib1"].getUnparsed() << std::endl;
    std::cout << "attrib2 = " << xl::NRef<xl::Element>(xml.root())["attrib2"].getUnparsed() << std::endl;
  ...
  std::cout << "XML_Create_At_Runtime exited." << std::endl;
  exit(EXIT_SUCCESS);
}
