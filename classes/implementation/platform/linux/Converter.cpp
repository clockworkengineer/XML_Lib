...
std::string IConverter::toUtf8(const std::u16string &utf16) const { return (utf16Convert.to_bytes(utf16)); }
...
/// </summary>
std::u16string IConverter::toUtf16(const std::string &utf8) const { return (utf16Convert.from_bytes(utf8)); }
